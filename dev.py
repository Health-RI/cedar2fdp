...
def post_cedar_instance_to_fdp(cedar_client: Client, template_id: str, config: dict) -> None:
    ...
    for resource in cedar_client.search_instances(template_id):
        ...
        foo.add((s, DCTERMS.isPartOf, URIRef('https://health-ri.sandbox.semlab-leiden.nl')))
